...
export const MISSING_KEY_FILENAME = 'Zipcelx config missing property filename';
export const MISSING_KEY_TITLE = 'Zipcelx config missing property sheet title';
export const INVALID_TYPE_FILENAME = 'Zipcelx filename can only be of type string';
